...
const schema = yup.object().shape({
    ...
    createPassword: yup.string().required().min(4,"minimum 4 characters required").max(10,"maximum 10 characters only"),
...
const SignUp = () => {
    ...
    return (
        ...
        <div className="box1">
            <form 
              ...
              onSubmit={handleSubmit((data) => {
                ...
                sessionStorage.setItem("password", data.confirmPassword);
                     return(<Login valid1={valid1} valid2={ valid2}/>)
              })}>
            ...
            onClick={()=>setFrom(false)} className='log-in'>Login</button>
            </form> 
            <p className='RED'>forgot password?</p>
            <p className='RED'>Go to login?click this <a href="/dashboard">LogIn</a></p>
